...
class culturalEvents extends StatefulWidget {
  @override
  State<culturalEvents> createState() => _culturalEventsState();
}

class _culturalEventsState extends State<culturalEvents> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('Events')
          .where('eventType', isEqualTo: 'Cultural')
          .snapshots(),
